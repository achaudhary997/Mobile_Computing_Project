...
public class LocationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("inside location class", "reafhed");
        ...
        if (restoreValuesFromBundle(savedInstanceState)) {
    ...
    public void returnValues() {
        dialog.dismiss();
        Log.d("Current Location in return values", mCurrentLocation.toString());
        Intent returnIntent = new Intent();
        returnIntent.putExtra("Latitude", mCurrentLocation.getLatitude());
        returnIntent.putExtra("Longitude", mCurrentLocation.getLongitude());
     ...
     */
    private boolean restoreValuesFromBundle(Bundle savedInstanceState) {
